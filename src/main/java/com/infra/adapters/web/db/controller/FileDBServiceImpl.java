...
public class FileDBServiceImpl implements FileDBService {
    ...
    public ResponseEntity<List<JpaFileAttributes>> getFilesOfDirAndPersist(@RequestParam(name="dirName") String dirName) throws Exception {
        ...
        fileAttributesPersistence.save(jpaFileList);
