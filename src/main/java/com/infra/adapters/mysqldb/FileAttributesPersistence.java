...
public class FileAttributesPersistence {
    ...
    public void save(JpaFileAttributes jpaFileAttributes) {
        fileAttributesRepo.save(jpaFileAttributes);
    }

    public void saveAll(Iterable<JpaFileAttributes> jpaFileList) {
